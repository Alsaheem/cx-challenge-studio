...
export class ItemAPIFlow extends Construct {
  ...
  constructor(scope: Construct, id: string, props: ItemApiProps) {
    ...
    const createOnelambda = new NodejsFunction(this, "createOneItemFunction", {
      entry: path.join(__dirname, "../../lambda/items/", "create.js"),
      ...nodeJsFunctionProps,
    });
    const getOneLambda = new NodejsFunction(this, "getOneItemFunction", {
      entry: path.join(__dirname, "../../lambda/items/", "get-one.js"),
      ...nodeJsFunctionProps,
    });
    const getAllLambda = new NodejsFunction(this, "getAllItemsFunction", {
      entry: path.join(__dirname, "../../lambda/items/", "get-all.js"),
      ...nodeJsFunctionProps,
    });
    const deleteOneLambda = new NodejsFunction(this, "deleteItemFunction", {
      entry: path.join(__dirname, "../../lambda/items/", "delete-one.js"),
      ...nodeJsFunctionProps,
    });
